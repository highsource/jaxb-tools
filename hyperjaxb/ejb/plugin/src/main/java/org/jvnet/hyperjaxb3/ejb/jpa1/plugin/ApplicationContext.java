...
import org.jvnet.hyperjaxb3.ejb.jpa1.strategy.mapping.EmbeddableAttributesMapping;
import org.jvnet.hyperjaxb3.ejb.jpa1.strategy.mapping.MarshalMappings;
...
public class ApplicationContext extends org.jvnet.hyperjaxb3.ejb.plugin.ApplicationContext {
    ...
    public PersistenceFactory createPersistenceFactory() {
        ...
        return new org.jvnet.hyperjaxb3.ejb.jpa1.strategy.processor.PersistenceFactory();
    }
    ...
    public PersistenceMarshaller createPersistenceMarshaller() {
        ...
        return new org.jvnet.hyperjaxb3.ejb.jpa1.strategy.processor.PersistenceMarshaller();
    }
    ...
    public CreateXAnnotations createCreateXAnnotations() {
        ...
        return new org.jvnet.hyperjaxb3.ejb.jpa1.strategy.annotate.CreateXAnnotations();
    }
}
