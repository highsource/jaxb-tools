...
public abstract class AbstractXJCMojo<O> extends AbstractMojo implements
    ...
    @Deprecated(forRemoval = true, since = "4.0.5-SNAPSHOT")
     ...
     * original bug has been resolved in 4.0.5-SNAPSHOT JAXB-RI
	 */
    @Deprecated(since = "4.0.5-SNAPSHOT", forRemoval = true)
