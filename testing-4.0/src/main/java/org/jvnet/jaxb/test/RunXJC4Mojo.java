...
import org.jvnet.mjiip.v_4_0.XJC40Mojo;
...
public class RunXJC4Mojo extends TestCase {
	/**
	 * Logger.
	 */
	protected Logger log = LoggerFactory.getLogger(RunXJC4Mojo.class);
