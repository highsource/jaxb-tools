...
public class FooElementTest extends RunXJC2Mojo {
    ...
    public void testFooElement() throws Exception {
        ...
        Assert.assertNotNull(fooElementClass);
        ...
        Assert.assertThrows(UnmarshalException.class,
        ...
        Assert.assertEquals(new ArrayList<>(Arrays.asList("a", "b", "c")), barAttributeField.get(elementWithValuesInAttribute));
        ...
        Assert.assertEquals(new ArrayList<>(), barAttributeField.get(elementWithEmptyAttribute));
        ...
        Assert.assertEquals(new ArrayList<>(Arrays.asList("a", "b", "c")), barAttributeField.get(clonedElementWithValuesInAttribute));
        // AND the copied list from the empty attribute is not null and empty
        Assert.assertNotNull(barAttributeField.get(clonedElementWithEmptyAttribute));
        Assert.assertTrue(((List<String>) barAttributeField.get(clonedElementWithEmptyAttribute)).isEmpty());
